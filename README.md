...
| managed\_rule\_group\_statement\_rules | n/a | <pre>list(object({<br>    name     = string<br>    priority = string<br>    managed_rule_group_statement = list(object({<br>      name                       = string<br>      vendor_name                = string<br>      excluded_rule              = list(string)<br>      block_rule_action_override = list(string)<br>    }))<br>  }))</pre> | n/a | yes |

...
| managed\_rule\_group\_statement\_rules | n/a | <pre>list(object({<br>    name     = string<br>    priority = string<br>    managed_rule_group_statement = list(object({<br>      name        = string<br>      vendor_name = string<br>      rule_action_override = list(object({<br>        name          = string<br>        action_to_use = string<br>      }))<br>      excluded_rule = list(object({<br>        name = string<br>      }))<br>    }))<br>  }))</pre> | n/a | yes |
